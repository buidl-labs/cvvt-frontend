...
export default function Footer() {
  return (
    <footer className="bg-primary-light-light text-gray-dark w-full px-32 py-16 grid grid-cols-2 gap-12 relative">
      ...
      <div className="flex flex-col">
        <div className="flex flex-1 space-x-2">
          <div className="w-1/3 space-y-5">
            ...
            <p>
              <a href="#" className="text-gray-dark hover:text-black underline">
                Contact us
              </a>
            </p>
          </div>
